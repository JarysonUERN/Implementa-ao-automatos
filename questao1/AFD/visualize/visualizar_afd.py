...
def visualizar_afd(caminho_json=None):
    ...
    plt.annotate(
        ...
        arrowprops=dict(
            ...
            lw=2.5,                # Largura da linha
            shrinkB=12             # Encolhe a ponta para não entrar no *centro* do nó
        ),
        zorder=1 # IMPORTANTE: desenha na camada 1 (atrás dos nós, que são zorder=2)
    )
